...
#for current version read /var/www/admin/version
ver=$1
webserver=$2
domain=$3
dbhost=$4
...
#version=$(head -n 1 /var/www/admin/version)
...
#	wget --no-check-certificate https://parapera.gr/repo/admin/gaia-$version.tar.gz -P /var/www
...
touch index.php
touch .htaccess
echo "<?php define('GAIAROOT',dirname(dirname(__FILE__)).'/admin/'); include GAIAROOT.'bootstrap.php'; ?>" >> /var/www/$domain/index.php
