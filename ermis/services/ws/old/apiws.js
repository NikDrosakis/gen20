...
const nik = require("../../api/functions");
...
app.get('/:type/:col', async (req, res, next) => {
    ...
    if (type == 'dataset') {
        ...
        const ma = require("../../api/dbs/maria")(req.params, config, nik);
...
app.post('/:type', async (req, res) => {
    ...
    req.body.type = type;
    const ma = require("../../api/dbs/maria")(req.body, config, nik);
    ma[type](function (data) {
