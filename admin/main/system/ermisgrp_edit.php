...
------------------------------------------------------>
<?php
$user=$this->gpm->f("SELECT * from ermisgrp where id=?",[$this->id]);
?>
    ...
    <div class="pagetitle-container">
        ...
        <span onclick="nextid()" class="btn btn-secondary">
         ...
         <button class="bare right" id="create_new_ermisgrp"><span class="glyphicon glyphicon-plus"></span>New Ermis</button>
...
<?php
echo $this->buildForm("gen_admin.ermisgrp",$user);
?>