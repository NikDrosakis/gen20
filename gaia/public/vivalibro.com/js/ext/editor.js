...
s.editor= {
    cliedit: function (file, selector) {
        ...
        gs.ui.reset(selector);
        gs.db().get({a: 'getcontent', b: file, c: 'encoded'}, function (data) {
            // console.log(data)
            $(selector)
    ...
    get: function () {
        ...
        if (editor_length) {
            ...
            gs.db().get({a: 'getcontents', b: filefolders}, function (data) {
    ...
    fditor: function (div, file) {
        ...
        if (typeof(basefilebox) != 'undefined') {
            ...
            gs.db().get({a: 'getcontent', b: file}, function (data) {
