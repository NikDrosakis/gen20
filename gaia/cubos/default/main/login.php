...
<div id="bg">
    <div class="module">
        ...
        <!-- Input fields -->
        <input class="input" required id="email" type="text" autocomplete="on" placeholder="Email">
        <input class="input" required id="pass" type="password" placeholder="Password">

        <!-- Buttons -->
        <div style="display: inline-flex;">
            <button class="button" type="button" onclick="gs.login()" id="loginf">Enter</button>
            <button class="button" type="button" onclick="location.href='/signup'">Signup</button>
        </div>

        <!-- Login with Google -->
        <div id="g_id_onload"
             data-client_id="<?= htmlspecialchars($this->is->GOOGLE_CLIENT_ID)?>"
             data-login_uri="<?= htmlspecialchars($this->is->GOOGLE_LOGIN_REDIRECT_URI) ?>"
