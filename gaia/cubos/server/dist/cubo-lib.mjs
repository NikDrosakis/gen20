...
function Lt() {
  ...
  K.constructor = H, U(K, $.prototype), K.isPureReactComponent = !0;
  ...
  function W(t, o, p) {
    ...
    return { $$typeof: T, type: t, key: w, ref: E, props: h, _owner: A.current };
  }
  function pe(t, o) {
  ...
  function G(t, o, p, y, h) {
    ...
    if (E) return E = t, h = h(E), t = y === "" ? "." + oe(E, 0) : y, F(h) ? (p = "", t != null && (p = t.replace(ve, "$&/") + "/"), G(h, o, p, "", function(P) {
      return P;
  ...
  return d.Children = { map: I, forEach: function(t, o, p) {
    ...
    return t;
  } }, d.Component = $, d.Fragment = ke, d.Profiler = fe, d.PureComponent = H, d.StrictMode = z, d.Suspense = te, d.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = ye, d.act = Q, d.cloneElement = function(t, o, p) {
...
function xt() {
  return Tr || (Tr = 1, function(T, l) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      function me(e) {
        if (Ir(e))
          return c("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Ar(e)), Ye(e);
      }
      function Dr(e, r, n) {
        var a = e.displayName;
        if (a)
      ...
      function xr(e, r, n) {
        ...
        if (r != null) {
          Ke(r) && (i = r.ref, Lr(r)), Ge(r) && (me(r.key), s = "" + r.key), f = r.__self === void 0 ? null : r.__self, v = r.__source === void 0 ? null : r.__source;
          for (a in r)
            ue.call(r, a) && !Be.hasOwnProperty(a) && (u[a] = r[a]);
        }
      ...
      function Nr(e, r, n) {
        ...
        if (r != null) {
          Ke(r) && (i = r.ref, m = A.current), Ge(r) && (me(r.key), s = "" + r.key);
          var g;
          e.type && e.type.defaultProps && (g = e.type.defaultProps);
          for (a in r)
            ue.call(r, a) && !Be.hasOwnProperty(a) && (r[a] === void 0 && g !== void 0 ? u[a] = g[a] : u[a] = r[a]);
        }
      ...
      function _e(e, r, n, a, u) {
        ...
        if (i) {
          ...
          if (he(v)) {
            var g = "";
            m != null && (g = Je(m) + "/"), _e(v, r, g, "", function($t) {
              return $t;
            });
          } else v != null && (X(v) && (v.key && (!f || f.key !== v.key) && me(v.key), v = Mr(
            v,
        ...
        var b, C, S = 0, k = a === "" ? Qe : a + Vr;
        if (he(e))
          for (var Oe = 0; Oe < e.length; Oe++)
            b = e[Oe], C = k + Ie(b, Oe), S += _e(b, r, n, C, u);
        else {
          var Ue = H(e);
          if (typeof Ue == "function") {
            var Cr = e;
            Ue === Cr.entries && (Xe || x("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), Xe = !0);
            for (var It = Ue.call(Cr), wr, Dt = 0; !(wr = It.next()).done; )
              b = wr.value, C = k + Ie(b, Dt++), S += _e(b, r, n, C, u);
          } else if (s === "object") {
            var Sr = String(e);
      ...
      var ie = -1, De = 0, Ze = 1, Kr = 2;
      function Gr(e) {
        if (e._status === ie) {
          var r = e._result, n = r();
          if (n.then(function(s) {
            if (e._status === De || e._status === ie) {
              var i = e;
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, u), u.default;
      ...
      function rr(e) {
        return !!(typeof e == "string" || typeof e == "function" || e === B || e === re || G || e === ee || e === V || e === ne || oe || e === le || ae || Pe || ve || typeof e == "object" && e !== null && (e.$$typeof === U || e.$$typeof === D || e.$$typeof === te || e.$$typeof === q || e.$$typeof === N || // This needs to include all possible module reference object
...
See https://reactjs.org/link/invalid-hook-call for tips about how to debug and fix this problem.`), e;
      ...
      var $e = I.ReactCurrentDispatcher, Fe;
      function be(e, r, n) {
        {
          if (Fe === void 0)
            try {
...
` + f[m].replace(" at new ", " at ");
          ...
          Le = !1, $e.current = s, yt(), Error.prepareStackTrace = u;
        }
      ...
      function Tt(e) {
        if (we === null)
          try {
            ...
            we = n.call(T, "timers").setImmediate;
          } catch {
            we = function(u) {
