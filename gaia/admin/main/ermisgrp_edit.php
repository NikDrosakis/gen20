...
------------------------------------------------------>
<?php
$user=$this->gpm->f("SELECT * from actiongrp where id=?",[$this->id]);
?>
    ...
    <div class="pagetitle-container">
        ...
        <span onclick="nextid()" class="btn btn-secondary">
         ...
         <button class="bare right" id="create_new_actiongrp"><span class="glyphicon glyphicon-plus"></span>New Ermis</button>
...
<?php
echo $this->buildForm("gen_admin.actiongrp",$user);
?>