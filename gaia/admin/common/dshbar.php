...
<button class="bare" onclick="openPanel('common/guide.php');gs.coo('openGuideChannel',1)"><span class="glyphicon glyphicon-question-sign"></span></button>
<button class="bare" onclick="openPanel('common/doc.php');gs.coo('openDocChannel',1)"><span class="glyphicon glyphicon-info-sign bare"></span></button>
